...
Folgende Schritte prüfen die Spielmechanik, Touch-Steuerung und Barrierefreiheit:

1. **Start**: `npm run dev` ausführen, Seite im Browser aufrufen.
2. **Tastatursteuerung**: Pacman lässt sich mit Pfeiltasten bewegen, Pause mit Leertaste.
